...
def render_dashboard():
    ...
    <div class='banner-card'>
        <div class='banner-copy'>
            <div class='eyebrow' style='margin-bottom:.3rem'>PERFORMANCE OVERVIEW</div>
            <h2 style='font-size:2rem; margin:0 0 .5rem 0'>Tu progreso semanal ahora se siente como una app premium real</h2>
            <div class='small'>Visual deportivo, capas de información y experiencia orientada a conversión y retención</div>
        </div>
    </div>
    ...
    st.markdown("""
    <div class='banner-card swim'>
        <div class='banner-copy'>
            <div class='eyebrow' style='margin-bottom:.3rem'>SWIM FOCUS</div>
            <h2 style='font-size:1.7rem; margin:0 0 .45rem 0'>Combina imagen, métricas y coaching en una misma narrativa visual</h2>
            <div class='small'>Esto ayuda a que el producto se vea más moderno, emocional y competitivo frente a otros SaaS deportivos</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
